...
# v14.9 – Stronger Rhythm Lattice from Nightingale Data + Rhythm Coherence
# =============================================================================

import numpy as np
from copy import deepcopy

print("✅ Nightingale Mapping Rosetta Stone v14.9 – Stronger Rhythm Lattice from Nightingale Data\n")
...
def run_search_v14_8(generations=120, pop_size=192, auto_scale=True):
    print(f"Running v14.9 self-iterating swarm (gens={generations}, pop={pop_size}, scale={auto_scale})...")
...
print("\n✅ v14.9 loaded – Stronger Rhythm Lattice from Nightingale Data.")
print(f"Derived ratios: {derived_ratios}")
print("File is always 'prototype.py'. Colab will always run this file.")
print("Type 'iterate' for v15.0 with temporal rhythm integration into lattice generation.")
